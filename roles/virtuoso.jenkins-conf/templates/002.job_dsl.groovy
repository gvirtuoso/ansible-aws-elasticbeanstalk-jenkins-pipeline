...
configXml = configXml + "          <defaultValue>task/pipeline_infrastructure</defaultValue>"
...
configXml = configXml + "      <targets>**/*.groovy</targets>"
...
configXml = configXml + "      <artifacts>**/*.groovy</artifacts>"
